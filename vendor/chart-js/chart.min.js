        ...
        1: [function (t, e, a) {
            ...
            e.exports = function (t) {
                ...
                t.defaults.bar = {
                    ...
                    calculateBarX: function (t, e) {
                        var a = this, i = a.getMeta(), n = a.getScaleForId(i.xAxisID), o = a.getBarIndex(e),
                        ...
                        e.extend(t, {
                            ...
                            draw: function () {
                                ...
                                var s = [[a.base, o], [a.base, n], [r, n], [r, o]],
                                    d = ["bottom", "left", "top", "right"], u = d.indexOf(a.borderSkipped, 0);
            ...
            e.exports = function (t) {
                ...
                a.doughnut = {
                    ...
                    getMaxBorderWidth: function (t) {
                        for (var e, a, i = 0, n = this.index, o = t.length,
                                 r = 0; o > r; r++)e = t[r]._model ? t[r]._model.borderWidth : 0, a = t[r]._chart ? t[r]._chart.config.data.datasets[n].hoverBorderWidth : 0, i = e > i ? e : i, i = a > i ? a : i;
                        return i
                    }
                })
            }
            ...
            e.exports = function (t) {
                ...
                t.defaults.polarArea = {
                    ...
                    updateElement: function (t, a, i) {
                        for (var n = this, o = n.chart, r = n.getDataset(), l = o.options, s = l.animation, d = o.scale,
                                 u = e.getValueAtIndexOrDefault, c = o.data.labels,
                                 h = n.calculateCircumference(r.data[a]), f = d.xCenter, g = d.yCenter, p = 0,
                                 m = n.getMeta(), b = 0; a > b; ++b)isNaN(r.data[b]) || m.data[b].hidden || ++p;
                ...
                t.types = {}, t.instances = {}, t.controllers = {}, t.Controller = function (a) {
                    ...
                    initialize: function () {
                        ...
                        i.scales && (o = o.concat((i.scales.xAxes || []).map(function (t) {
                            ...
                            if (l) {
                                var s = new l({id: o.id, options: o, ctx: a.chart.ctx, chart: a});
                        ...
                        return o ? (e.each(a.data.datasets, function (t, e) {
                            if (a.isDatasetVisible(e)) {
                                var i = a.getDatasetMeta(e), r = i.data[o._index];
                        ...
                        var a = this, i = e.getRelativePosition(t, a.chart), n = [], o = function () {
                            if (a.data.datasets)for (var t = 0; t < a.data.datasets.length; t++) {
                                var e = a.getDatasetMeta(t);
                                if (a.isDatasetVisible(t))for (var n = 0; n < e.data.length; n++)if (e.data[n].inLabelRange(i.x, i.y))return e.data[n]
                            }
                        }.call(a);
                        return o ? (e.each(a.data.datasets, function (t, i) {
                            if (a.isDatasetVisible(i)) {
                                var r = a.getDatasetMeta(i), l = e.findIndex(r.data, function (t) {
                        ...
                        for (var t = 0, e = 0,
                                 a = this.data.datasets.length; a > e; ++e)this.isDatasetVisible(e) && t++;
                        return t
                ...
                t.DatasetController = function (t, e) {
                    ...
                    removeHoverStyle: function (t, a) {
                        var i = this.chart.data.datasets[t._datasetIndex], n = t._index, o = t.custom || {},
                            r = e.getValueAtIndexOrDefault, l = t._model;
                    ...
                    setHoverStyle: function (t) {
                        var a = this.chart.data.datasets[t._datasetIndex], i = t._index, n = t.custom || {},
                            o = e.getValueAtIndexOrDefault, r = e.getHoverColor, l = t._model;
                ...
                t.defaults.global.legend = {
                    ...
                    initialize: function (t) {
                        ...
                        var a = this, i = a.options, n = i.labels, o = i.display, r = a.ctx, l = t.defaults.global,
                            ...
                            h = e.fontString(d, u, c), f = a.legendHitBoxes = [], g = a.minSize, p = a.isHorizontal();
                        ...
                        if (i.display) {
                            ...
                            var b = n.boxWidth, v = a.legendHitBoxes, x = function (e, a, n) {
                                if (!(isNaN(b) || 0 >= b)) {
                                    ...
                                    if (u.setLineDash && u.setLineDash(c(n.lineDash, r.borderDash)), i.labels && i.labels.usePointStyle) {
                                        var s = f * Math.SQRT2 / 2, d = s / Math.SQRT2, h = e + d, g = a + d;
                            ...
                            e.each(a.legendItems, function (t, e) {
                                var i = u.measureText(t.text).width,
                                    o = n.usePointStyle ? f + f / 2 + i : b + f / 2 + i, r = d.x, c = d.y;
                        ...
                        var a = this, i = a.options, n = "mouseup" === t.type ? "click" : t.type;
                        if ("mousemove" === n) {
                            if (!i.onHover)return
                        } else {
                            if ("click" !== n)return;
                        ...
                        var o = e.getRelativePosition(t, a.chart.chart), r = o.x, l = o.y;
                        if (r >= a.left && r <= a.right && l >= a.top && l <= a.bottom)for (var s = a.legendHitBoxes,
                                                                                                d = 0; d < s.length; ++d) {
                            var u = s[d];
                ...
                t.defaults.scale = {
                    ...
                    calculateTickRotation: function () {
                        ...
                        if (a.labelRotation = o.minRotation || 0, a.paddingRight = 0, a.paddingLeft = 0, a.options.display && a.isHorizontal()) {
                            ...
                            for (var f, g, p = e.longestText(i, d, a.ticks, a.longestTextCache), m = p,
                                     b = a.getPixelForTick(1) - a.getPixelForTick(0) - 6; m > b && a.labelRotation < o.maxRotation;) {
                    ...
                    fit: function () {
                        ...
                        if (u ? i.width = a.isFullWidth() ? a.maxWidth - a.margins.left - a.margins.right : a.maxWidth : i.width = d && s.drawTicks ? m : 0, u ? i.height = d && s.drawTicks ? m : 0 : i.height = a.maxHeight, l.display && d && (u ? i.height += 1.5 * p : i.width += 1.5 * p), r.display && d) {
                            ...
                            if (u) {
                                ...
                                var M = a.maxWidth - i.width, D = r.mirror;
                    ...
                    draw: function (a) {
                        ...
                        if (n.display) {
                            ...
                            var p = e.getValueOrDefault(d.fontColor, s.defaultFontColor),
                                ...
                                D = e.getValueOrDefault(c.fontFamily, s.defaultFontFamily), I = e.fontString(C, M, D),
                            ...
                            if (e.each(i.ticks, function (t, r) {
                                    if (void 0 !== t && null !== t) {
                                        ...
                                        if ((!s || l) && void 0 !== t && null !== t) {
                                            ...
                                            var p, m, b, v, x, w, C, M, D, I, T = "middle", P = "middle";
                                            if (g) {
                                    ...
                                    if (u.display && (l.save(), l.lineWidth = t.glWidth, l.strokeStyle = t.glColor, l.setLineDash && (l.setLineDash(t.glBorderDash), l.lineDashOffset = t.glBorderDashOffset), l.beginPath(), u.drawTicks && (l.moveTo(t.tx1, t.ty1), l.lineTo(t.tx2, t.ty2)), u.drawOnChartArea && (l.moveTo(t.x1, t.y1), l.lineTo(t.x2, t.y2)), l.stroke(), l.restore()), d.display) {
                                        ...
                                        var a = t.label;
                                        if (e.isArray(a))for (var i = 0,
                                                                  n = -(a.length - 1) * m * .75; i < a.length; ++i)l.fillText("" + a[i], 0, n), n += 1.5 * m; else l.fillText(a, 0, 0);
                                        l.restore()
                                    }
                                }), c.display) {
                                var O, B, W = 0;
                            ...
                            if (u.drawBorder) {
                                ...
                                var N = i.left, H = i.right, E = i.top, U = i.bottom, q = e.aliasPixel(l.lineWidth);
            ...
            e.exports = function (t) {
                ...
                t.Title = t.Element.extend({
                    ...
                    draw: function () {
                        ...
                        if (o.display) {
                            var l, s, d = n(o.fontSize, r.defaultFontSize), u = n(o.fontStyle, r.defaultFontStyle),
                                c = n(o.fontFamily, r.defaultFontFamily), h = e.fontString(d, u, c), f = 0, g = a.top,
                                p = a.left, m = a.bottom, b = a.right;
            ...
            e.exports = function (t) {
                ...
                t.defaults.global.tooltips = {
                    ...
                    initialize: function () {
                        ...
                        var i, o, r, l, s, d, u = this._view, c = this._chart.ctx, h = u.caretSize, f = u.cornerRadius,
                            g = u.xAlign, p = u.yAlign, m = t.x, b = t.y, v = e.width, x = e.height;
            ...
            e.exports = function (t) {
                ...
                a.elements.arc = {
                    ...
                    inLabelRange: function (t) {
                        ...
                        var i = this._view;
                        if (i) {
                            for (var n = e.getAngleFromPoint(i, {x: t, y: a}), o = n.angle, r = n.distance,
                                     l = i.startAngle, s = i.endAngle; l > s;)s += 2 * Math.PI;
                            for (; o > s;)o -= 2 * Math.PI;
                            for (; l > o;)o += 2 * Math.PI;
            ...
            e.exports = function (t) {
                ...
                t.defaults.global.elements.line = {
                    ...
                    draw: function () {
                        ...
                        var i = this, n = i._view, o = n.spanGaps, r = n.scaleZero, l = i._loop, s = i._chart.ctx;
                        s.save();
            ...
            e.exports = function (t) {
                ...
                a.elements.point = {
                    ...
                    inRange: function (t, e) {
                        ...
                        var n = this._view, o = this._chart.ctx, r = n.pointStyle, l = n.radius, s = n.x, d = n.y;
            ...
            e.exports = function (t) {
                ...
                t.LinearScaleBase = t.Scale.extend({
                    handleTickRangeOptions: function () {
                        ...
                        var t = this, a = t.options, i = t.ticks = [], n = a.ticks, o = e.getValueOrDefault,
                            r = t.getTickLimit();
                        r = Math.max(2, r);
            ...
            e.exports = function (t) {
                var e = t.helpers, a = {
                    ...
                    determineDataLimits: function () {
                        ...
                        for (var t = this, a = t.options, i = a.ticks, n = e.getValueOrDefault, o = t.ticks = [],
                                 r = n(i.min, Math.pow(10, Math.floor(e.log10(t.min)))); r < t.max;) {
                            o.push(r);
                            var l, s;
                    ...
                    getValueCount: function () {
                        ...
                        if (i.display) {
                            ...
                            if (e.each(t.ticks, function (r, l) {
                                ...
                                for (var g = t.getDistanceFromCenterForValue(i.reverse ? t.min : t.max),
                                         p = s(l.fontSize, a.defaultFontSize), m = s(l.fontStyle, a.defaultFontStyle),
                                         b = s(l.fontFamily, a.defaultFontFamily), v = e.fontString(p, m, b),
                                         x = t.getValueCount() - 1; x >= 0; x--) {
                                    if (r.display) {
                                    ...
                                    var w = t.pointLabels, C = this.getIndexAngle(x) + Math.PI / 2,
